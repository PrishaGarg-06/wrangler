 ...
 */
 ...
 public class GrammarIdentifierTest {
     ...
     public void testParseByteSize() {
         ...
         assertEquals(10240, GrammarIdentifier.parseByteSize("10KB"));
     ...
     public void testParseTimeDuration() {
         ...
         assertEquals(10000, GrammarIdentifier.parseTimeDuration("10s"));   // 10 seconds in milliseconds
         assertEquals(300000, GrammarIdentifier.parseTimeDuration("5m"));    // 5 minutes in milliseconds
         assertEquals(7200000, GrammarIdentifier.parseTimeDuration("2h"));   // 2 hours in milliseconds
         assertEquals(60000, GrammarIdentifier.parseTimeDuration("1m"));     // 1 minute in milliseconds
     }
 }
